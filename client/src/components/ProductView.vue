<template>
  <div class="container-fluid">
        ...
        >
          ...
          <div class="card-body">
            <table class="table">
              <thead>
                <tr>
                  <th scope="col" style="max-width: 172px;">{{products[(p-1)*4].name}}</th>
                </tr>
              </thead>
              <tbody>
                <tr>
        ...
        >
          ...
          <div class="card-body">
            <table class="table">
              <thead>
                <tr>
                  <th scope="col" style="max-width: 172px;">{{products[(p-1)*4 + 1].name}}</th>
                </tr>
              </thead>
              <tbody>
                <tr>
        ...
        >
          ...
          <div class="card-body">
            <table class="table">
              <thead>
                <tr>
                  <th scope="col" style="max-width: 172px;">{{products[(p-1)*4 + 2].name}}</th>
                </tr>
              </thead>
              <tbody>
                <tr>
        ...
        >
          ...
          <div class="card-body">
            <table class="table">
              <thead>
                <tr>
                  <th scope="col" style="max-width: 172px;">{{products[(p-1)*4 + 3].name}}</th>
                </tr>
              </thead>
              <tbody>
                <tr>
    ...
    <b-modal ref="my-modal" hide-footer hide-header @hide="onModalClose">
      <div class="container-fluid m-0 p-0" v-if="currentProduct != -1">
        <div class="jumbotron" style="background-color: white;">
          ...
          <h1 class="display-4 mb-3">Hinnad</h1>
        ...
        <div class="d-flex justify-content-between align-items-center">
          <button
            v-on:click.prevent="hideInfo"
            id="menubutton"
            class="btn btn-primary float-left"
          >Tagasi</button>
          <button
            v-if="products[this.currentProduct].productPrices[0].store != 'MAXIMA'"
            v-on:click.prevent="addToShoppingcart(currentProduct)"
            id="menubutton"
...
<script>
var address =
  "http://ec2-184-72-206-167.compute-1.amazonaws.com:8080/products/0/24/name/asc";
...
export default {
  ...
  watch: {
    ...
    filter: function() {
      ...
      if (this.filter == "KOIK") {
        address =
          "http://ec2-184-72-206-167.compute-1.amazonaws.com:8080/products/0/24/" +
          this.currentSort +
          "/" +
          this.currentDirection;
        this.currentCategory = null;

<template>
  <div class="container">
    <div class="mt-4">
      <p class="h1 display-4 mb-4">Rapordid</p>
      <b-table
        show-empty
        stacked="md"
        fixed
      ...
      >
        ...
        <template slot="actions" slot-scope="row">
          ...
          >{{ !row.detailsShowing ? "N2ita tekkinud vigu" : "Peida tekkinud vead"}}</b-button>
        </template>
    ...
    <div class="mt-4">
      <p class="h1 display-4 mb-4">Scraperi staatus</p>
      <div class="py-2 px-5">
      <p class="h6" :key="scraperStatus">
        {{scraperStatus}}
      </p>
      ...
      <b-button
        ...
        variant="link"
        @click="startScraper()"
      ><p class="small d-inline-block mr-4"> K2ivita uuendus</p>
        <font-awesome-icon icon="play"/>
      </b-button>
      <p class="h6">{{scraperStartMessage}}</p>
    </div>
    </div>
  </div>
</template>
